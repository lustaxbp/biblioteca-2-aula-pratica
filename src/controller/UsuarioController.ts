...
class UsuarioController extends Usuario {
    ...
    // Dentro de UsuarioController.ts, adicione este método estático:
    static async listar(req: Request, res: Response) {
        try {
            const usuarios = await Usuario.listarUsuarios(); // Assume que você tenha esse método no modelo Usuario
